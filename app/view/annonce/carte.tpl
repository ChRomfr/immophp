<!--
    START ANNONCE/CARTE.TPL
-->
{if $config.bread == 1 && !isset($smarty.get.nohtml) && !isset($smarty.get.print)}
<ul class="breadcrumb">
	<li><a href="{getLink("index")}" title="">{$lang.Accueil}</a><span class="divider">/</span></li>
	<li><a href="{getLink("annonce")}" title="{$lang.Annonces}">{$lang.Annonces}</a><span class="divider">/</span></li>
	<li>{$lang.Carte}</li>
</ul>
{/if}
...
<div class="well">
    ...
    <div id="blokRechercheBien" style="display:none;">
        <!-- START TITRE BLOK -->
        ...
        <div class="bloc_gauche_corp">
            <form method="get" action="{getLink("annonce/carte")}">
                <div class="center">
                ...
                <input type="text" name="criteres[surface_min]" value="{if isset($smarty.get.criteres.surface_min) && !empty($smarty.get.criteres.surface_min)}{$smarty.get.criteres.surface_min}{else}{$lang.Min}{/if}" /><span class="devise">m²</span>
                <div class="blokRechercheSeparator"></div>
                <input type="text" name="criteres[surface_max]" value="{if isset($smarty.get.criteres.surface_max) && !empty($smarty.get.criteres.surface_max)}{$smarty.get.criteres.surface_max}{else}{$lang.Max}{/if}" /><span class="devise">m²</span>
                <div class="clear"></div>
	...
	<div class="google_map">{$Carte}</div>
</div>