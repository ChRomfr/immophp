...
<form method="post" action="#" class="form-horizontal well">
	<fieldset>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" name="groupe[name]" id="name" class="input-xxlarge" value="{$groupe->name}"/>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<textarea type="text" name="groupe[description]" id="description" class="input-xxlarge">{$groupe->description}</textarea>
			</div>
		</div>
