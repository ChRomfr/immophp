...
jQuery(document).ready(function(){
	...
	$('#links_list td img.delete').live('click', function(){
...
<form id="formMenu" action="#" method="post" class="">
	<fielset>
	...
	<div class="fright">
		<a href="javascript:add_link();" title=""><img src="{$smarty.const.URL_IMG_ACTION}add.png" alt="" /></a>
	</div>
	<div class="clear"></div>
	{* TABLEAU DES LIENS *}
